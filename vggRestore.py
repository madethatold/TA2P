...
def run():
  ...
  train_data, train_labels = generateSpecializedData('D:\lifeng\workSpace\CDRP_SourceCode\cifar-100-python/train', targetList, 500, 0)
  test_data, test_labels = generateSpecializedData("D:\lifeng\workSpace\CDRP_SourceCode\cifar-100-python/test", targetList, 500, 0)
